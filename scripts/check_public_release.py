...
REQUIRED_FILES = [
    ...
    "miaoshou_tool/ai.py",
    "miaoshou_tool/ai_pages.py",
    "miaoshou_tool/ai_requests.py",
    "miaoshou_tool/batch_jobs.py",
    "miaoshou_tool/batch_pages.py",
    "miaoshou_tool/batch_requests.py",
    "miaoshou_tool/config.py",
    "miaoshou_tool/errors.py",
    "miaoshou_tool/files.py",
    "miaoshou_tool/forms.py",
    "miaoshou_tool/http_routes.py",
    "miaoshou_tool/http_context.py",
    "miaoshou_tool/http_server.py",
    "miaoshou_tool/job_runners.py",
    "miaoshou_tool/jobs.py",
    "miaoshou_tool/single_product.py",
    "miaoshou_tool/single_pages.py",
    "miaoshou_tool/single_requests.py",
    "miaoshou_tool/system_pages.py",
    "miaoshou_tool/json_io.py",
    "miaoshou_tool/job_pages.py",
    ...
    "miaoshou_tool/service_bridge.py",
